...
import output_facebook from "./output.facebook/info";
AllComponents.push((r: Registration) => output_facebook(r) as unknown as NodeInfo<BaseConfig>);
import output_linkedin from "./output.linkedin/info";
AllComponents.push((r: Registration) => output_linkedin(r) as unknown as NodeInfo<BaseConfig>);
...
import output_twitch from "./output.twitch/info";
AllComponents.push((r: Registration) => output_twitch(r) as unknown as NodeInfo<BaseConfig>);
...
import output_youtube from "./output.youtube/info";
AllComponents.push((r: Registration) => output_youtube(r) as unknown as NodeInfo<BaseConfig>);
