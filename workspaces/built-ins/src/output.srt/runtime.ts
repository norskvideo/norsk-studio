...
import { InstanceRouteInfo, OnCreated, ServerComponentDefinition, StudioRuntime, StudioNodeSubscriptionSource, CreatedMediaNode, InstanceRouteArgs } from '@norskvideo/norsk-studio/lib/extension/runtime-types';
...
export default class SrtOutputDefinition implements ServerComponentDefinition<SrtOutputSettings, SrtOutput, SrtOutputState, SrtOutputCommand, SrtOutputEvent> {
  ...
  async instanceRoutes(): Promise<InstanceRouteInfo<SrtOutputSettings, SrtOutput, SrtOutputState, SrtOutputCommand, SrtOutputEvent>[]> {
    return defineApi<paths, InstanceRouteArgs<SrtOutputSettings, SrtOutput, SrtOutputState, SrtOutputCommand, SrtOutputEvent>>(
